 ...
 * @author emad
 */
@WebServlet(name = "ShowState", urlPatterns = {"/ShowState"})
public class ShowState extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList <String> ss = S.Show_All_State();
            ...
            se.setAttribute("State_Buttons",A);
            RequestDispatcher y=request.getRequestDispatcher("ShowAllReuest.jsp");
