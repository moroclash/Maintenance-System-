<%-- 
    Document   : show request
    Created on : May 11, 2016, 9:05:07 AM
    Author     : moahmed A.Radwan
--%>
<%@page import="java.util.Map"%>
<%@page import="java.util.HashMap"%>
<%@page import="SE.Device"%>
                                ...
                                <form  method="post" name="FirstForm" action="" >
                                    <div  id="proff"> 
                                        <%
                                                ...
                                                ArrayList<Device> dev=(ArrayList<Device>)session.getAttribute("DEvecs");
                                        ...
                                        <label  class="Input" > </label>
                                         ...
                                         <label style="font-size: 20px"  class="top">Date : </label>  
                                        <label   class="Input" > <%=date%></label>
                                        <label style="font-size: 20px"  class="top">service name : </label>  
                                        <label  class="Input" ><%=User%> </label>
                                        <%for(Device d:dev)
                                        { 
                                            HashMap<String,String>ss =d.getMy_info();
                                            for (Map.Entry<String, String> entrySet : ss.entrySet()) {
                                            String key = entrySet.getKey();
                                            String value = entrySet.getValue();
                                        %>
                                                
                                       <label style="font-size: 20px"  class="top">service name : </label>  
                                        <label type="text" name="service" class="Input" ><%=value%> </label>
                                        <%}}%>
                                        <br>
                                        <br>
                                        <% 
