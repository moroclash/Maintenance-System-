   ...
   <html>
    ...
    <body>
        ...
        <%
            ...
            ArrayList<String> HTML=(ArrayList<String>) se.getAttribute("Types");
            %>
    
                            <h2 id="in" >Select User Type</h2> 
                            <hr class="in2">


                            <div id="prof">
                                <form action="AfterTypes">
                                    <select style="margin-left:280px " name="Type">
                                        <%
                                         ...
                                         <input style="margin-left:0px" type="submit" value="Add New Actor" id="info1" name="SELECT">  
