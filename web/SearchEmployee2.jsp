...
<html>
    ...
    <body>
        <%
            ...
            Employee P=(Employee) se.getAttribute("Obj3");
            int i=(Integer) se.getAttribute("Test");
            String Test;
        ...
        <section id="container" >
            ...
            *********************************************************************************************************************************************************** -->
            ...
            %>
                        ...
                        <li class="mt">
                            <a class="active" href="Manager_profile.jsp">
                            ...
                            <div id="prof">
                                <form action="SearchEmployee" method="post">
                                    <div  id="proff"> 
                                        ...
                                        <center>   
                                            <input type="text"  name="id" id="ser" placeholder="Enter ID/Name" autofocus  class="top1s"></center><br>
                                            <input type="submit" name="b1" value="search" id="info1">
                                            <br>
                                        <label style="font-size: 20px" for="Firstname" class="tops">First Name: </label>  
                                        <label type="text" id="Firstname"  class="Inputs"><%=P.Fname%>
                                        </label>
                                        <label style="font-size: 20px" for="Lastname" class="tops">Last Name :  </label>  
                                        <label  id="Lastname"  class="Inputs"><%=P.Lname%>
                                        </label>
                                        <label style="font-size: 20px" for="Email" class="tops">Email  : </label>  
                                        <label  id="Email" class="Inputs" ><%=P.Email%>
                                        </label>


                                        <label style="font-size: 20px" for="SSn" class="tops">SSN: </label>  
                                        <label type="text" id="SSn" class="Inputs"><%=P.Ssn%>
                                        </label>

                                        <label style="font-size: 20px" for="salary" class="tops"> Salary : </label>  
                                        <label type="text" id="salary"  class="Inputs"><%=P.Salary%>
                                        </label>

                                        <label style="font-size: 20px" for="Address" class="tops">Adress  : </label>  
                                        <label type="text" id="Address"  class="Inputs"><%=P.Address%>
                                        </label>

                                        <label style="font-size: 20px" for="BD" class="tops">BirthDate  : </label>  
                                        <label  id="BD"  class="Inputs"><%=P.Bearthdate%>
                                        </label>
                                        <label style="font-size: 20px" for="phone" class="tops">Phone : </label>  
                                        <label  id="phone"  class="Inputs"><%=P.Phone%>
                                        </label>
                                        <label style="font-size: 20px" for="workH" class="tops">Work hours: </label>  
                                        <label type="text" id="workH" placeholder="Work Hours"  required class="Inputs"><%=P.Workhours%>
                                        </label>

                                        <label style="font-size: 20px" for="Gender" class="tops"> Gender  : </label>  
                                        <label  required class="Inputs"><%=P.Gender%>
                                        </label>
                                        <br>
                                        
                                    </div>
                                    <hr class="in2">  
                                    <a href="#"> <input id="info" name="b1" type="submit" value="update"  >	</a>	
                                    <a href="#"><input id="Delet" name="b1"  type="submit" value="delete"></a>
                                    <a href="#"><input id="info1" name="b1" type="submit" value=<%=Test%>></a>
                                </form>
