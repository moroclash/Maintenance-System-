 ...
 * @author mohamedsalah
 */
@WebServlet(name = "AddnewPhone", urlPatterns = {"/AddnewPhone"})
public class AddnewPhone extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String Alert1 = "";
           S.Add_New_Phone_To_User(New_phone, User_id);
            
              Alert1 = "New Address Added";  
