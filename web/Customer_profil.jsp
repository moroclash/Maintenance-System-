<%-- 
    ...
    Created on : Mar 28, 2016, 7:52:02 PM
    Author     : moroclash
--%>
...
<html>
    <head>
        ...
        <title>Maintenence Customer</title>
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            <a href="javascript:;" id="custorders" >
                        ...
                        <li class="sub-menu">
                            <a class="active" href="javascript:;" >
                                <i class="fa fa-cogs" id="custreport"></i>
                        ...
                        <li class="sub-menu">
                            <a href="javascript:;" id="custcomplian" >
                        ...
                        <li class="sub-menu">
                            <a href="javascript:;" id="custfeedback" >
                                <i class="fa fa-book"></i>
                                <span>Feedback</span>
                            </a>
